...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v1, p0, Lcom/android/server/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;

    .line 712
    new-instance v1, Lcom/android/server/StatusBarManagerService$8;

    invoke-direct {v1, p0}, Lcom/android/server/StatusBarManagerService$8;-><init>(Lcom/android/server/StatusBarManagerService;)V
    ...
    .line 127
    new-instance v1, Lcom/android/server/StatusBarManagerService$1;

    new-instance v2, Landroid/os/Handler;

    invoke-direct {v2}, Landroid/os/Handler;-><init>()V

    invoke-direct {v1, p0, v2}, Lcom/android/server/StatusBarManagerService$1;-><init>(Lcom/android/server/StatusBarManagerService;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/android/server/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v4, p0, Lcom/android/server/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;

    iget v5, p0, Lcom/android/server/StatusBarManagerService;->mCurrentUserId:I

    invoke-virtual {v1, v2, v3, v4, v5}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    .line 139
    invoke-direct {p0}, Lcom/android/server/StatusBarManagerService;->updateSystemIconExclusionList()V

    .line 140
    invoke-direct {p0}, Lcom/android/server/StatusBarManagerService;->refreshAllSystemIcons()V
...
.method static synthetic access$100(Lcom/android/server/StatusBarManagerService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/StatusBarManagerService;
...
.method static synthetic access$200(Lcom/android/server/StatusBarManagerService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/StatusBarManagerService;
...
.method private disableLocked(IILandroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/StatusBarManagerService$2;-><init>(Lcom/android/server/StatusBarManagerService;I)V
...
.method private refreshAllSystemIcons()V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/server/StatusBarManagerService;->setIconVisibility(Ljava/lang/String;Z)V
...
.method private updateSystemIconExclusionList()V
    ...
    iget v7, p0, Lcom/android/server/StatusBarManagerService;->mCurrentUserId:I
    ...
    iget-object v5, p0, Lcom/android/server/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;
...
.method private updateUiVisibilityLocked(II)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/StatusBarManagerService$5;-><init>(Lcom/android/server/StatusBarManagerService;II)V
...
.method public onHardKeyboardStatusChange(ZZ)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/StatusBarManagerService$7;-><init>(Lcom/android/server/StatusBarManagerService;ZZ)V
...
.method public setCameraAssist(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/statusbar/IStatusBar;->setCameraAssist(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setCurrentUser(I)V
    ...
    iget-object v1, p0, Lcom/android/server/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, Lcom/android/server/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;
...
.method public setHardKeyboardEnabled(Z)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/StatusBarManagerService$6;-><init>(Lcom/android/server/StatusBarManagerService;Z)V
...
.method public setIcon(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)V
    ...
    .line 267
    iget-object v1, p0, Lcom/android/server/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;
...
.method public setIconVisibility(Ljava/lang/String;Z)V
    ...
    iget-object v3, p0, Lcom/android/server/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;
...
.method public setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    new-instance v2, Lcom/android/server/StatusBarManagerService$4;

    invoke-direct {v2, p0, p1, p2, p3}, Lcom/android/server/StatusBarManagerService$4;-><init>(Lcom/android/server/StatusBarManagerService;Landroid/os/IBinder;II)V
...
.method public topAppWindowChanged(Z)V
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/server/StatusBarManagerService$3;-><init>(Lcom/android/server/StatusBarManagerService;Z)V
