...
.method private updatePublicVolumeState(Landroid/os/storage/StorageVolume;Ljava/lang/String;)V
    ...
    .line 678
    .local v9, "oldState":Ljava/lang/String;
    ...
    const-string v13, "Duplicate state transition (%s -> %s) for %s"
    ...
    .line 679
    .end local v9    # "oldState":Ljava/lang/String;
    :catchall_0
    move-exception v12
    ...
    .line 687
    .restart local v9    # "oldState":Ljava/lang/String;
    :cond_0
    const-string v12, "MountService"
    ...
    const-string v14, "volume state changed for "
    ...
    iget-object v12, v0, Lcom/android/server/MountService;->mPms:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-virtual {v12, v13, v14, v15}, Lcom/android/server/pm/PackageManagerService;->updateExternalMediaStatus(ZZZ)V
    ...
    iget-object v12, v0, Lcom/android/server/MountService;->mListeners:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v12, v1, Lcom/android/server/MountService$MountServiceBinderListener;->mListener:Landroid/os/storage/IMountServiceListener;

    move-object/from16 v0, p2

    invoke-interface {v12, v10, v9, v0}, Landroid/os/storage/IMountServiceListener;->onStorageStateChanged(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    ...
    invoke-virtual {v0, v7, v8}, Landroid/os/storage/StorageVolume;->setMaxFileSize(J)V
    ...
    const-string v14, "Listener dead"
    ...
    const-string v14, "Listener failed"
