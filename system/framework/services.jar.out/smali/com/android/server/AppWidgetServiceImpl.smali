...
.method static synthetic access$000(Lcom/android/server/AppWidgetServiceImpl;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/AppWidgetServiceImpl;

    .prologue
    .line 91
    invoke-direct {p0}, Lcom/android/server/AppWidgetServiceImpl;->ensureStateLoadedLocked()Z
...
.method private ensureStateLoadedLocked()Z
    ...
    .line 444
    .local v0, "update":Z
    iget-boolean v2, p0, Lcom/android/server/AppWidgetServiceImpl;->mStateLoaded:Z
    ...
    .line 449
    invoke-virtual {p0}, Lcom/android/server/AppWidgetServiceImpl;->loadStateLocked()Z
    ...
    iput-boolean v2, p0, Lcom/android/server/AppWidgetServiceImpl;->mStateLoaded:Z
...
.method private getHostWithTag(Ljava/util/List;I)Lcom/android/server/AppWidgetServiceImpl$Host;
    .locals 3
    .param p2, "tag"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 1923
    .local p1, "list":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/AppWidgetServiceImpl$Host;>;"
    ...
    iget v2, v0, Lcom/android/server/AppWidgetServiceImpl$Host;->tag:I
...
.method public bindRemoteViewsService(ILandroid/content/Intent;Landroid/os/IBinder;)V
    ...
    .line 728
    :cond_0
    invoke-direct/range {p0 .. p0}, Lcom/android/server/AppWidgetServiceImpl;->ensureStateLoadedLocked()Z
...
.method loadStateLocked()Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/AppWidgetServiceImpl;->readStateFromFileLocked(Ljava/io/FileInputStream;)Z
    :try_end_0
...
.method readStateFromFileLocked(Ljava/io/FileInputStream;)Z
    ...
    .line 1751
    .local v16, "loadedProviders":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetServiceImpl$Provider;>;"
    const/4 v13, 0x0

    .line 1753
    .local v13, "hostIndex":I
    :cond_0
    ...
    .line 1900
    .end local v13    # "hostIndex":I
    .end local v16    # "loadedProviders":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetServiceImpl$Provider;>;"
    ...
    check-cast v35, Lcom/android/server/AppWidgetServiceImpl$Host;
    ...
    .restart local v13    # "hostIndex":I
    .restart local v16    # "loadedProviders":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetServiceImpl$Provider;>;"
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/content/pm/PackageManager;->currentToCanonicalPackageNames([Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 1793
    new-instance v12, Lcom/android/server/AppWidgetServiceImpl$Host;

    invoke-direct {v12}, Lcom/android/server/AppWidgetServiceImpl$Host;-><init>()V

    .line 1797
    .local v12, "host":Lcom/android/server/AppWidgetServiceImpl$Host;
    const/16 v35, 0x0
    ...
    iput-object v0, v12, Lcom/android/server/AppWidgetServiceImpl$Host;->packageName:Ljava/lang/String;
    :try_end_5
    ...
    .line 1799
    :try_start_6
    iget-object v0, v12, Lcom/android/server/AppWidgetServiceImpl$Host;->packageName:Ljava/lang/String;
    ...
    iput v0, v12, Lcom/android/server/AppWidgetServiceImpl$Host;->uid:I
    :try_end_6
    ...
    :goto_5
    :try_start_7
    iget-boolean v0, v12, Lcom/android/server/AppWidgetServiceImpl$Host;->zombie:Z
    ...
    iput v0, v12, Lcom/android/server/AppWidgetServiceImpl$Host;->hostId:I

    .line 1808
    iput v13, v12, Lcom/android/server/AppWidgetServiceImpl$Host;->tag:I
    ...
    iput-boolean v0, v12, Lcom/android/server/AppWidgetServiceImpl$Host;->zombie:Z
    :try_end_7
    ...
    .end local v12    # "host":Lcom/android/server/AppWidgetServiceImpl$Host;
    .end local v13    # "hostIndex":I
    .end local v16    # "loadedProviders":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetServiceImpl$Provider;>;"
    .end local v26    # "parser":Lorg/xmlpull/v1/XmlPullParser;
    .end local v29    # "providerIndex":I
    ...
    .line 1819
    .local v15, "id":Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;
    const/16 v35, 0x0
    ...
    check-cast v35, Lcom/android/server/AppWidgetServiceImpl$Provider;
    ...
    invoke-direct {v0, v1, v11}, Lcom/android/server/AppWidgetServiceImpl;->getHostWithTag(Ljava/util/List;I)Lcom/android/server/AppWidgetServiceImpl$Host;
    ...
    .end local v11    # "hIndex":I
    .end local v13    # "hostIndex":I
    .end local v15    # "id":Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;
    .end local v16    # "loadedProviders":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/server/AppWidgetServiceImpl$Provider;>;"
    ...
    const-string v36, "Failed to read state, clearing widgets and hosts."
