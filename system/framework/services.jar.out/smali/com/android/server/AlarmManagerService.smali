...
.method static synthetic access$2400(Ljava/io/PrintWriter;Ljava/util/ArrayList;Ljava/lang/String;JJ)V
    .locals 0
    ...
    .prologue
    .line 78
    invoke-static/range {p0 .. p6}, Lcom/android/server/AlarmManagerService;->dumpAlarmList(Ljava/io/PrintWriter;Ljava/util/ArrayList;Ljava/lang/String;JJ)V
...
.method private secureUniqueOperationLocked(Ljava/util/HashSet;Landroid/app/PendingIntent;)V
    .locals 1
    ...
    .prologue
    .line 490
    .local p1, "uniqueList":Ljava/util/HashSet;, "Ljava/util/HashSet<Landroid/app/PendingIntent;>;"
    ...
    .line 491
    invoke-virtual {p0, p2}, Lcom/android/server/AlarmManagerService;->removeLocked(Landroid/app/PendingIntent;)V
...
.method private setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;)V
    ...
    invoke-virtual {v6}, Lcom/android/server/AlarmManagerService$StaminaController;->isAlarmsSuppressedLocked()Z
    ...
    invoke-virtual {v6, v5}, Lcom/android/server/AlarmManagerService$StaminaController;->isWhitelistedLocked(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {v6, v5}, Lcom/android/server/AlarmManagerService$StaminaController;->addSuppressedAlarmLocked(Lcom/android/server/AlarmManagerService$Alarm;)V
...
.method private setRebatchedAlarmLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;)V
    .locals 21
    .param p1, "type"    # I
    .param p2, "when"    # J
    .param p4, "whenElapsed"    # J
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v4, v0, Lcom/android/server/AlarmManagerService;->mStaminaController:Lcom/android/server/AlarmManagerService$StaminaController;

    move-object/from16 v5, p2

    invoke-virtual/range {v4 .. v9}, Lcom/android/server/AlarmManagerService$StaminaController;->dump(Ljava/io/PrintWriter;JJ)V
...
.method public firstWakelockAcquired(J)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/AlarmManagerService$StaminaController;->resumeAlarmsAfter(J)V
...
.method rebatchAllAlarmsLocked(Z)V
    ...
    .line 423
    .local v29, "uniqueList":Ljava/util/HashSet;, "Ljava/util/HashSet<Landroid/app/PendingIntent;>;"
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    invoke-direct {v0, v1, v6}, Lcom/android/server/AlarmManagerService;->secureUniqueOperationLocked(Ljava/util/HashSet;Landroid/app/PendingIntent;)V
    ...
    invoke-direct/range {v6 .. v21}, Lcom/android/server/AlarmManagerService;->setRebatchedAlarmLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;)V
...
.method public removeLocked(Landroid/app/PendingIntent;)V
    ...
    iget-object v1, v0, Lcom/android/server/AlarmManagerService;->mStaminaController:Lcom/android/server/AlarmManagerService$StaminaController;

    move-object/from16 v0, p1

    invoke-virtual {v1, v0}, Lcom/android/server/AlarmManagerService$StaminaController;->remove(Landroid/app/PendingIntent;)V
