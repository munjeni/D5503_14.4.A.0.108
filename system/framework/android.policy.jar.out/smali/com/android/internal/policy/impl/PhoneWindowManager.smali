...
.field mEmergencyMasterResetWithEncrypted:Z
...
.field private mKeepScreenOnWakelock:Landroid/os/PowerManager$WakeLock;
...
.field private mVendorTvHomeLongPressed:Z
...
.method public constructor <init>()V
    ...
    .line 377
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSomcHdmiDemoMode:Z
    ...
    .line 401
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mEmergencyMasterResetWithEncrypted:Z
...
.method static synthetic access$1300(Lcom/android/internal/policy/impl/PhoneWindowManager;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindowManager;
...
.method static synthetic access$2300(Lcom/android/internal/policy/impl/PhoneWindowManager;II)I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindowManager;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method private declared-synchronized acquireWakeLockToEnableKeepingScreenOn()V
    .locals 1
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->wakeUpPhone()V

    .line 6454
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeepScreenOnWakelock:Landroid/os/PowerManager$WakeLock;
...
.method private applySecurityLevelToCameraKeyLongPressDetectionTask()V
    .locals 2
    ...
    .line 4801
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCameraKeyLongPressDetectionTask:Lcom/android/internal/policy/impl/PhoneWindowManager$CameraKeyLongPressDetectionTask;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager$CameraKeyLongPressDetectionTask;->applySecurityLevel(Z)V
...
.method private interceptCameraKeyEvent(IIIIIZ)V
    ...
    .line 4700
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->applySecurityLevelToCameraKeyLongPressDetectionTask()V
...
.method private interceptVirtualCameraKeyEvent(IZ)V
    .locals 2
    .param p1, "action"    # I
...
.method private readConfigurationDependentBehaviors()V
    ...
    .line 1230
    iget v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDoubleTapOnHomeBehavior:I
    ...
    .line 1232
    :cond_2
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDoubleTapOnHomeBehavior:I
...
.method private declared-synchronized releaseWakeLockToDisableKeepingScreenOn(Z)V
    .locals 1
    .param p1, "isWakeUp"    # Z
...
.method private startTvHomeApplication()V
    ...
    const-string v2, "com.sonymobile.action.SHOW_TV_HOME"
...
.method private updateSystemUiVisibilityLw()I
    ...
    invoke-direct {v6, p0, v3, v4, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager$31;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;ILandroid/view/WindowManagerPolicy$WindowState;Z)V
...
.method private wakeUpPhone()V
    ...
    const-string v3, "wakeLockForWakeUpPhone in PhoneWindowManager"
    ...
    .line 6486
    .local v0, "wakeLockForWakeUpPhone":Landroid/os/PowerManager$WakeLock;
    invoke-virtual {v0}, Landroid/os/PowerManager$WakeLock;->acquire()V
...
.method public applyPostLayoutPolicyLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    iget-boolean v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mEmergencyMasterResetWithEncrypted:Z
...
.method public getKeyguardComponentFactoryClass()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->getCurrentKeyguardComponentFactoryClass()Ljava/lang/String;
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    invoke-virtual {v9, v10}, Lcom/android/internal/policy/impl/WindowOrientationListener;->setCurrentRotation(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v11, "PhoneWindowManager.mQuickBootWakeLock"

    invoke-virtual {v9, v10, v11}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v9

    iput-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuickBootWakeLock:Landroid/os/PowerManager$WakeLock;

    .line 1051
    const-string v9, "ro.quickboot.press_duration"
    ...
    iput v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLongPressPoweronTime:I
    ...
    .line 1077
    iget-boolean v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mButtonLightEnabled:Z
    ...
    invoke-static {v9}, Landroid/os/IHardwareService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/IHardwareService;

    move-result-object v9

    iput-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLight:Landroid/os/IHardwareService;

    .line 1081
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLight:Landroid/os/IHardwareService;
    ...
    const-string v11, "FastCaptureFrameworkWakeLock"

    invoke-virtual {v9, v10, v11}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v9

    iput-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFastCaptureWakeLock:Landroid/os/PowerManager$WakeLock;

    .line 1092
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFastCaptureWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    .line 1152
    new-instance v6, Lcom/android/internal/policy/impl/PhoneWindowManager$ScreenOnOffReceiver;

    invoke-direct {v6, p0, p1}, Lcom/android/internal/policy/impl/PhoneWindowManager$ScreenOnOffReceiver;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/content/Context;)V

    .line 1153
    .local v6, "screenOnOffReceiver":Lcom/android/internal/policy/impl/PhoneWindowManager$ScreenOnOffReceiver;
    ...
    const-string v9, "org.codeaurora.intent.action.WIFI_DISPLAY_VIDEO"

    invoke-direct {v7, v9}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 1160
    .local v7, "wifiDisplayFilter":Landroid/content/IntentFilter;
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWifiDisplayReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p1, v9, v7}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    move-result-object v8

    .line 1163
    .local v8, "wifidisplayIntent":Landroid/content/Intent;
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;
    ...
    .line 1181
    .local v2, "filterScreenCapture":Landroid/content/IntentFilter;
    const-string v9, "com.sonymobile.intent.action.SCREEN_CAPTURE"

    invoke-virtual {v2, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1182
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mScreenCaptureReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1186
    .local v3, "filterUserActivity":Landroid/content/IntentFilter;
    const-string v9, "com.sonyericsson.intent.action.stk.user_activity_request"

    invoke-virtual {v3, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1187
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mUserActivityReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v11, "PhoneWindowManager.mKeepScreenOnWakelock"

    invoke-virtual {v9, v10, v11}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v9

    iput-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeepScreenOnWakelock:Landroid/os/PowerManager$WakeLock;
    ...
    .line 1193
    .local v5, "redKeyEvent":Landroid/content/IntentFilter;
    const-string v9, "com.sonymobile.action.PROG_RED_KEYEVENT"

    invoke-virtual {v5, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1194
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mProgRedKeyEventReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1198
    .local v0, "carMirrorLinkModeFilter":Landroid/content/IntentFilter;
    const-string v9, "com.sonymobile.intent.action.CAR_MIRRORLINK_MODE"

    invoke-virtual {v0, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1199
    iget-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMirrorLinkModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCarMirrorLinkMode:Z
    ...
    .line 1212
    :goto_1
    new-instance v9, Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;

    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v9, v10}, Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;-><init>(Landroid/content/Context;)V

    iput-object v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPS3BtIntentSender:Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;
    ...
    .line 1026
    .end local v0    # "carMirrorLinkModeFilter":Landroid/content/IntentFilter;
    .end local v1    # "filter":Landroid/content/IntentFilter;
    .end local v2    # "filterScreenCapture":Landroid/content/IntentFilter;
    .end local v3    # "filterUserActivity":Landroid/content/IntentFilter;
    .end local v4    # "intent":Landroid/content/Intent;
    .end local v5    # "redKeyEvent":Landroid/content/IntentFilter;
    .end local v6    # "screenOnOffReceiver":Lcom/android/internal/policy/impl/PhoneWindowManager$ScreenOnOffReceiver;
    .end local v7    # "wifiDisplayFilter":Landroid/content/IntentFilter;
    .end local v8    # "wifidisplayIntent":Landroid/content/Intent;
    :catch_0
    move-exception v9
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-object v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPS3BtIntentSender:Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;
    ...
    invoke-virtual {v3, v5}, Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;->isWirelessController(Ljava/lang/String;)Z
    ...
    .line 2546
    invoke-interface/range {v36 .. v36}, Lcom/android/internal/telephony/ITelephony;->endCall()Z
    :try_end_2
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVendorTvHomeLongPressed:Z
    ...
    iput-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVendorTvHomeLongPressed:Z
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    iget v6, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLastSystemUiFlags:I

    move-object/from16 v0, p0

    invoke-direct {v0, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isImmersiveMode(I)Z

    move-result v6

    move/from16 v0, p3

    invoke-virtual {v2, v0, v3, v4, v6}, Lcom/android/internal/policy/impl/ImmersiveModeConfirmation;->onPowerKeyDown(ZJZ)V
    ...
    iget-boolean v2, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mButtonLightEnabled:Z
    ...
    iget-object v2, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLight:Landroid/os/IHardwareService;

    const/4 v3, 0x0

    invoke-interface {v2, v3}, Landroid/os/IHardwareService;->setButtonLightEnabled(Z)V
    :try_end_4
    ...
    const-string v3, "remote call for turn off button light failed."
    ...
    invoke-direct {v0, v2, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptVirtualCameraKeyEvent(IZ)V
...
.method public rotationForOrientationLw(II)I
    ...
    iget-boolean v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSomcHdmiDemoMode:Z
    ...
    .end local v0    # "preferredRotation":I
    :cond_e
    iget-boolean v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCarMirrorLinkMode:Z
...
.method public setEmergencyMasterReset()V
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->setEmergencyMasterResetModeEnabled()V
...
.method setHdmiPlugged(Z)V
    ...
    .line 4051
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->acquireWakeLockToEnableKeepingScreenOn()V
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->releaseWakeLockToDisableKeepingScreenOn(Z)V
...
.method public setKeyguardComponentFactory(Landroid/content/ComponentName;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->setKeyguardComponentFactory(Landroid/content/ComponentName;)V
