...
.method private dispatchEvent(Ljava/lang/String;)Z
    ...
    const-string v7, "cert files may be incorrect"
    ...
    const-string v9, "Receives Malformed supplicant event: "
    ...
    .line 673
    :cond_8
    const-string v7, "INTERWORKING-SSID-ADDED"
    ...
    iget-object v6, p0, Landroid/net/wifi/WifiMonitor$MonitorThread;->mWifiMonitorSingleton:Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;

    # getter for: Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->mToHostapd:Z
    invoke-static {v6}, Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->access$400(Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;)Z
    ...
    :goto_4
    invoke-virtual {v8, v6}, Lcom/android/internal/util/StateMachine;->sendMessage(I)V
...
.method public run()V
    ...
    # getter for: Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->mToHostapd:Z
    invoke-static {v7}, Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->access$400(Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;)Z
    ...
    # invokes: Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->getConnectedMonitor()Landroid/net/wifi/WifiMonitor;
    invoke-static {v7}, Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->access$500(Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;)Landroid/net/wifi/WifiMonitor;
    ...
    invoke-static {v7, v9}, Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->access$702(Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;Z)Z

    .line 630
    iget-object v7, p0, Landroid/net/wifi/WifiMonitor$MonitorThread;->mWifiMonitorSingleton:Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;

    # setter for: Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->mToHostapd:Z
    invoke-static {v7, v9}, Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;->access$402(Landroid/net/wifi/WifiMonitor$WifiMonitorSingleton;Z)Z
