...
.method static synthetic access$12100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$UserAuthorizingJoinState;
    .locals 1
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
...
.method static synthetic access$5100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Z
    ...
    .prologue
    .line 419
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->checkAndUpdateIncomingDeviceInfoList(Ljava/lang/String;)Z
...
.method static synthetic access$6700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$UserAuthorizingInviteRequestState;
    .locals 1
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
...
.method static synthetic access$6900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # Ljava/lang/String;
...
.method static synthetic access$7600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pDeviceList;
    .locals 1
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
...
.method static synthetic access$8200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    .prologue
    .line 419
    invoke-direct {p0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->dismissNotifyDialog()V
...
.method private checkAndUpdateIncomingDeviceInfoList(Ljava/lang/String;)Z
    .locals 6
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$5300(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/util/ArrayList;
    ...
    check-cast v0, Landroid/net/wifi/p2p/WifiP2pService$IncomingDeviceInfo;

    .line 2358
    .local v0, "info":Landroid/net/wifi/p2p/WifiP2pService$IncomingDeviceInfo;
    iget-wide v4, v0, Landroid/net/wifi/p2p/WifiP2pService$IncomingDeviceInfo;->expiredTime:J
    ...
    .line 2360
    :cond_1
    iget-object v4, v0, Landroid/net/wifi/p2p/WifiP2pService$IncomingDeviceInfo;->deviceAddress:Ljava/lang/String;
    ...
    .line 2365
    .end local v0    # "info":Landroid/net/wifi/p2p/WifiP2pService$IncomingDeviceInfo;
    :goto_1
    return v4
...
.method private dismissNotifyDialog()V
    ...
    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->mNotifyDialog:Landroid/app/AlertDialog;
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$12800(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/app/AlertDialog;
    ...
    # setter for: Landroid/net/wifi/p2p/WifiP2pService;->mNotifyDialog:Landroid/app/AlertDialog;
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12802(Landroid/net/wifi/p2p/WifiP2pService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
...
.method private notifyInvitationReceived()V
    ...
    invoke-direct {p0, v6}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->checkAndUpdateIncomingDeviceInfoList(Ljava/lang/String;)Z
    ...
    # setter for: Landroid/net/wifi/p2p/WifiP2pService;->mNotifyDialog:Landroid/app/AlertDialog;
    invoke-static {v6, v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$12802(Landroid/net/wifi/p2p/WifiP2pService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
...
.method private notifyP2pProvDiscShowPinRequest(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mSavedPeerConfig:Landroid/net/wifi/p2p/WifiP2pConfig;

    .line 2238
    iget-object v4, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mSavedPeerConfig:Landroid/net/wifi/p2p/WifiP2pConfig;

    iput-object p2, v4, Landroid/net/wifi/p2p/WifiP2pConfig;->deviceAddress:Ljava/lang/String;
    ...
    iput-object p1, v4, Landroid/net/wifi/WpsInfo;->pin:Ljava/lang/String;
    ...
    new-instance v6, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$2;

    invoke-direct {v6, p0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$2;-><init>(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    # setter for: Landroid/net/wifi/p2p/WifiP2pService;->mNotifyDialog:Landroid/app/AlertDialog;
    invoke-static {v4, v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$12802(Landroid/net/wifi/p2p/WifiP2pService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
...
.method private p2pConnectWithPinDisplay(Landroid/net/wifi/p2p/WifiP2pConfig;)V
    ...
    invoke-static {v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$6600(Landroid/net/wifi/p2p/WifiP2pService;)Z
