...
.field static final SPTYPE_HS2_HOME:I = 0x1

.field static final SPTYPE_HS2_ROAMING:I = 0x2

.field static final SPTYPE_HS2_UNKNOWN:I = 0x3

.field static final SPTYPE_NOT_EXIST:I

.field private static mDisableGlobalInterface:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/net/wifi/WifiNative;->mDisableGlobalInterface:Z
...
.method private doBooleanCommand(Ljava/lang/String;)Z
    ...
    .line 175
    sget-boolean v2, Landroid/net/wifi/WifiNative;->mDisableGlobalInterface:Z

    if-eqz v2, :cond_0

    invoke-direct {p0, p1}, Landroid/net/wifi/WifiNative;->doBooleanCommandNative(Ljava/lang/String;)Z
...
.method private doIntCommand(Ljava/lang/String;)I
    ...
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiNative;->doIntCommandNative(Ljava/lang/String;)I
...
.method private doStringCommand(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiNative;->doStringCommandNative(Ljava/lang/String;)Ljava/lang/String;
...
.method private doStringCommandWithoutLogging(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 212
    :try_start_0
    sget-boolean v0, Landroid/net/wifi/WifiNative;->mDisableGlobalInterface:Z
...
.method public static native setMaxTxPower(IZ)Z
.end method

.method public static native startSupplicant(ZI)Z
.end method
...
.method public closeHostapdConnection()V
    ...
    .line 162
    invoke-direct {p0}, Landroid/net/wifi/WifiNative;->closeHostapdConnectionNative()V
...
.method public connectToHostapd()Z
    ...
    .line 157
    invoke-direct {p0}, Landroid/net/wifi/WifiNative;->connectToHostapdNative()Z
...
.method public enableAutoInterworking(Z)V
    .locals 1
    .param p1, "enabled"    # Z
...
.method public getCredentialVariable(ILjava/lang/String;)Ljava/lang/String;
    .locals 2
    .param p1, "credId"    # I
...
.method public getHs2SpType()I
    ...
    .line 1059
    .local v5, "token":Ljava/lang/String;
    const-string/jumbo v10, "sp_type="
...
.method public hs2AnqpReq(Ljava/lang/String;)Z
    .locals 2
    .param p1, "bssid"    # Ljava/lang/String;
...
.method public listCredentials()Ljava/lang/String;
    .locals 1

    .prologue
    .line 1032
    const-string v0, "LIST_CREDS"
...
.method public removeCredential(I)Z
    .locals 2
    .param p1, "credId"    # I
...
.method public setCredentialVariable(ILjava/lang/String;Ljava/lang/String;)Z
    .locals 2
    .param p1, "credId"    # I
    .param p2, "name"    # Ljava/lang/String;
...
.method public setScanDelay(I)Z
    .locals 2
    .param p1, "delay"    # I
