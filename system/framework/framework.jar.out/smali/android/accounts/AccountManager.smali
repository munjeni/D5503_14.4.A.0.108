...
.method private getTokenForListener(Landroid/accounts/OnAccountsUpdateListener;)Ljava/lang/Object;
    .locals 5
    ...
    .line 2130
    .local v0, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/accounts/OnAccountsUpdateListener;Landroid/os/Handler;>;"
    ...
    .line 2135
    .end local v0    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/accounts/OnAccountsUpdateListener;Landroid/os/Handler;>;"
...
.method private postToHandler(Landroid/os/Handler;Landroid/accounts/OnAccountsUpdateListener;[Landroid/accounts/Account;)V
    ...
    .line 1444
    :cond_0
    invoke-direct {p0, p2}, Landroid/accounts/AccountManager;->getTokenForListener(Landroid/accounts/OnAccountsUpdateListener;)Ljava/lang/Object;
    ...
    const-string/jumbo v3, "warning, failed to get a token from listener.... ignore anyway...."
    ...
    invoke-direct {v2, p0, p2, v0}, Landroid/accounts/AccountManager$12;-><init>(Landroid/accounts/AccountManager;Landroid/accounts/OnAccountsUpdateListener;[Landroid/accounts/Account;)V

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v3

    invoke-virtual {p1, v2, v1, v3, v4}, Landroid/os/Handler;->postAtTime(Ljava/lang/Runnable;Ljava/lang/Object;J)Z
...
.method public removeOnAccountsUpdatedListener(Landroid/accounts/OnAccountsUpdateListener;)V
    ...
    const-string v4, "Listener was not previously added"
    ...
    .line 2111
    :cond_2
    invoke-direct {p0, p1}, Landroid/accounts/AccountManager;->getTokenForListener(Landroid/accounts/OnAccountsUpdateListener;)Ljava/lang/Object;
